"""
LaptopTester Pro - Definitive Build Script (v2.7.9)
Added Good/Error buttons for Hardware Identification and License Check steps.
"""
...
def main():
    ...
    if sys.platform == 'win32':
        ...
        subprocess.run(['taskkill', '/F', '/IM', 'LaptopTesterPro_v2.7.8.exe'], capture_output=True, check=False)
